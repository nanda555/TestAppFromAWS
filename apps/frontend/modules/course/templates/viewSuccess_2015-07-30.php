...
echo "<br> ===potential_eschools======";
print_r($potential_eschools);
echo "<br> ===current_eschools======";
print_r($current_eschools);
echo "<br> =========";

		
		$ind_ctlg_crse_count[$product_list_key] = 0;
		foreach($potential_eschools as $potential_eschool_key=>$potential_eschool_val) {
			if($ind_products_details[$product_list_key]["catalog_short_name"] == $potential_eschool_key) {
echo "Test step 2";				
			//if(isset($catalog_courses_count[$potential_eschool_key]) && $catalog_courses_count[$potential_eschool_key] > 0) {
		
				$ind_ctlg_crse_count[$product_list_key] = $catalog_courses_count[$potential_eschool_key];
				$int_all_catalogs_count = $int_all_catalogs_count + $catalog_courses_count[$potential_eschool_key];
					//$ind_ctlg_crse_lists[$product_list_key][$current_eschool_key] = substr($current_eschool_val, 1, strlen($current_eschool_val));
				$ind_ctlg_crse_lists[$product_list_key][$potential_eschool_key] = $potential_eschool_val;
				$ind_all_catalogs_list[] = $potential_eschool_val;
				//}
			}
		}			
	} else {
		...
		$ind_ctlg_crse_count[$product_list_key] = 0;
		foreach($potential_eschools as $potential_eschool_key=>$potential_eschool_val) {
echo "<br> ===ind_products_details======".$ind_products_details[$product_list_key]["catalog_short_name"]."<br>";
echo "<br> ===potential_eschool_key======".$potential_eschool_key."<br>";		
			if($ind_products_details[$product_list_key]["catalog_short_name"] == $potential_eschool_key) {
echo "<br> <b>***ind_products_details======</b>".$ind_products_details[$product_list_key]["catalog_short_name"]."<br>";
echo "<br> <b>***potential_eschool_key======</b>".$potential_eschool_key."<br>";
echo "<br> ===catalog_courses_count======".$catalog_courses_count[$potential_eschool_key]."<br>";
...
foreach($cert_products_list as $product_list_key=>$product_list_val)
{
	...
	if ($mhr_institution_obj) {
		...
		foreach($current_eschools as $current_eschool_key=>$current_eschool_val) {
			if($cert_products_details[$product_list_key]["catalog_short_name"] == $current_eschool_key) {
		...
		foreach($catalog_courses_count as $catalog_courses_count_key=>$catalog_courses_count_val) {
			if($catalog_courses_count_key == $eschool_short_name ) {
				//if ($catalog_courses_count_val > 0) {
					...
					$ind_ctlg_crse_lists[$product_list_key][$potential_eschool_key] = $eschool_val;
		...
		foreach($catalog_courses_count as $catalog_courses_count_key=>$catalog_courses_count_val) {
			if($catalog_courses_count_key == $eschool_short_name ) {
				//if ($catalog_courses_count_val > 0) {
					...
					$cert_ctlg_crse_lists[$product_list_key][$potential_eschool_key] = $eschool_val;
...
/*
echo "<br> <b>============================================cert_products_details[ind_ctlg_crse_count]======</b><br>";
print_r($cert_ctlg_crse_count);
echo "<br>==============<b> certifications </b>=========================<br>";
echo "<br>=====cert_all_catalogs_count======<br>";
echo $cert_all_catalogs_count;
echo "<br>=====cert_ctlg_crse_count======<br>";
print_r($cert_ctlg_crse_count);
echo "<br>=====cert_all_catalogs_list======<br>";
print_r($cert_all_catalogs_list);
echo "<br>=====cert_ctlg_crse_lists======<br>";
print_r($cert_ctlg_crse_lists);
echo "<br>=====cert_products_details======<br>";
...
foreach($ind_products_details as $ind_products_detail_key=>$ind_products_detail_val)
{
	...
	?>
		<div class="col-md-4">
			...
			&nbsp;-&nbsp;<?php echo isset($ind_ctlg_crse_count[$ind_products_detail_val["short_name"]]) ? $ind_ctlg_crse_count[$ind_products_detail_val["short_name"]] : 0; ?> courses
		</div>
	<?php
	if($loop_i%3 == 0) {
...
<div class="panel panel-success">
	...
	<div id="collapseOneCS<?php echo $products_detail_val["id"]; ?>" class="panel-collapse collapse" style="height: 0px;">
		<div class="panel-body">
			...
			//}
			?>
			<?php /* <h4>Courses Catalog: <a data-toggle="collapse" data-parent="#accordion1" href="#ind_collapseCourse_<?php echo $ctlg_crse_list_key; ?>"><span style="color:red;"><?php echo $ctlg_crse_list_val; ?></span>&nbsp;<i class="fa fa-folder-open-o"></i></a></h4>
			<div id="ind_collapseCourse_<?php echo $ctlg_crse_list_key; ?>" class="panel-collapse collapse">
				<table cellpadding="0" cellspacing="0" border="0" class="display" id="ind_courses_list_<?php echo $ctlg_crse_list_key; ?>" width="100%" align="left"> */ ?>
			
			<h4>Courses Catalog:</h4><p><b><a data-toggle="collapse" data-parent="#accordion1" href="#ind_collapseCourse_<?php echo $ctlg_crse_list_key; ?>"><?php echo $ctlg_crse_list_val; ?>&nbsp;<i class="fa fa-folder-open-o"></i></a></b></p>


part 1 Here
<!-- start div table part here  -->
			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="ind_courses_list_<?php echo $ctlg_crse_list_key; ?>" width="100%" align="left">				
				...
				//jQuery(document).ready( function () {
					$('#ind_courses_list_<?php echo $ctlg_crse_list_key; ?>').dataTable( {
						"paging": false,
						"ordering": false,
						"info": false
					} );
...
//if(isset($cert_ctlg_crse_count[$cert_products_detail_val["short_name"]]) && $cert_ctlg_crse_count[$cert_products_detail_val["short_name"]] > 0) {
	?>
		<div class="col-md-4">
			...
			&nbsp;-&nbsp;<?php echo isset($cert_ctlg_crse_count[$cert_products_detail_val["short_name"]]) ? $cert_ctlg_crse_count[$cert_products_detail_val["short_name"]] : 0; ?> courses
		</div>
	<?php
	if($loop_i%3 == 0) {
		?></div><div class="row"><?php
...
<div class="panel panel-success">
	...
	<div id="collapseOneCS<?php echo $products_detail_val["id"]; ?>" class="panel-collapse collapse">
		<div class="panel-body">
			...
			//}
			?>
			<h4>Courses Catalog: <a data-toggle="collapse" data-parent="#accordion2" href="#cert_collapseCourse_<?php echo $ctlg_crse_list_key; ?>"><span style="color:red;"><?php echo $ctlg_crse_list_val; ?></span>&nbsp;<i class="fa fa-folder-open-o"></i></a></h4>
			<div id="cert_collapseCourse_<?php echo $ctlg_crse_list_key; ?>" class="panel-collapse collapse">
