...
<div class="panel panel-success">
	...
	<div id="collapseOneCS<?php echo $products_detail_val["id"]; ?>" class="panel-collapse collapse">
		<div class="panel-body">
			...
			//}
			?>
			<h4>Courses Catalog: <a data-toggle="collapse" data-parent="#accordion" href="#ind_collapseCourse_<?php echo $ctlg_crse_list_key; ?>"><span style="color:red;"><?php echo $ctlg_crse_list_val; ?></span>&nbsp;<i class="fa fa-folder-open-o"></i></a></h4>
