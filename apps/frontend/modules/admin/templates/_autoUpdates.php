<form action="<?php echo ('autoUpdates')?>" method="POST">
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          <input type="submit" class="button" value="Submit" onclick="return confirmPost('Are you sure you want to PERFORM AUTO-UPDATES?')" />
        </td>
      </tr>
    </tfoot>
    <tbody>
