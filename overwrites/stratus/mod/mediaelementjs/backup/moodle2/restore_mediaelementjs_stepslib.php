 ...
 */
class restore_mediaelementjs_activity_structure_step extends restore_activity_structure_step {

    protected function define_structure() {

        $paths = array();
        $paths[] = new restore_path_element('mediaelementjs', '/activity/mediaelementjs');
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_mediaelementjs', 'intro', null);
    }
}
