...
require_once($CFG->dirroot . '/mod/mediaelementjs/backup/moodle2/backup_mediaelementjs_stepslib.php'); // Because it exists (must)

/**
 * URL backup task that provides all the settings and steps to perform one
 * complete backup of the activity
 */
class backup_mediaelementjs_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_mediaelementjs_activity_structure_step('url_structure', 'url.xml'));
    }
    ...
    static public function encode_content_links($content) {
        ...
        $base = preg_quote($CFG->wwwroot.'/mod/mediaelementjs','#');
