 ...
 */
class backup_mediaelementjs_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $url = new backup_nested_element('mediaelementjs', array('id'), array(
        ...
        // Define sources
        $url->set_source_table('mediaelementjs', array('id' => backup::VAR_ACTIVITYID));

        // Define id annotations
        //module has no id annotations

        // Define file annotations
        $url->annotate_files('mod_mediaelementjs', 'intro', null); // This file area hasn't itemid
