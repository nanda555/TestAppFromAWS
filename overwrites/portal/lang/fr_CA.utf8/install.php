...
$string['aboutdefaultcontent'] = '<h2>À propos de Mahara</h2>

<p>Établi en 2006, Mahara est le résultat d\'une consortium fondé par le New Zealand\'s Tertiary Education Commission\'s e-learning Collaborative Development Fund (eCDF), impliquant  l\'Université Massey, L\'Université de Technologie d\'Auckland, L\'Open Polytechnic de Nouvelle Zélande et l\'Université Victoria de Wellington.</p>

<p>Mahara est un système complet de portfolio électronique, de blog, de curriculum vitae et de réseau social, pour relier des utilisateurs et créer des communautés en ligne. Mahara est conçu pour fournir aux utilisateurs les outils leur permettant de créer un environnement de développement personnel et professionnel.</p>

<p>Le mot maori Mahara signifie « penser » ou « pensée ». Il reflète l\'idée d\'un projet voué à la cration d\'une application centrée sur l\'apprentissage tout au long de la vie des utilisateurs, ainsi que sur la conviction que les solutions technologiques ne peuvent pas être développées sans tenir compte des considérations pédagogiques et politiques.</p>

<p>Mahara est fourni gratuitement comme logiciel libre (Open Source) sous la licence « GNU General Public License ». Cela signifie en bref que vous pouvez copier, utiliser et modifier Mahara tant que vous vous déclarez d\'accord de :</p>

<ul>
    <li>fournir le code source à la communauté,</li>
    <li>ne pas modifier ou supprimer la licence originale, ni les copyrights, et</li>
    <li>utiliser cette même licence à tous les travaux dérivés.</li>
</ul>

<p>N\'hésitez pas à <a href="contact.php">nous contacter</a> si vous avez des questions au sujet de Mahara.</p>

<p><a href="http://mahara.org">http://mahara.org</a></p>';
$string['homedefaultcontent'] = '<h2>Bienvenue sur Mahara</h2>

<p>Mahara est un système complet de portfolio électronique, de blog, de curriculum vitae et de réseau social, pour relier des utilisateurs et créer des communautés en ligne. Mahara est conçu pour fournir aux utilisateurs les outils leur permettant de créer un environnement de développement personnel et professionnel.</p>

<p>Pour plus d\'information, veuillez consulter <a href="about.php">À propos de</a> Mahara. N\'hésitez pas à <a href="contact.php">nous contacter</a> si vous avez des questions au sujet de Mahara.</p>';
$string['loggedouthomedefaultcontent'] = '<h2>Bienvenue sur Mahara</h2>

<p>Mahara est un système complet de portfolio électronique, de blog, de curriculum vitae et de réseau social, pour relier des utilisateurs et créer des communautés en ligne. Mahara est conçu pour fournir aux utilisateurs les outils leur permettant de créer un environnement de développement personnel et professionnel.</p>

<p>Pour plus d\'information, veuillez consulter <a href="about.php">À propos de</a> Mahara. N\'hésitez pas à <a href="contact.php">nous contacter</a> si vous avez des questions au sujet de Mahara.</p>';
$string['privacydefaultcontent'] = '<h2>Protection des données</h2>
...
$string['termsandconditionsdefaultcontent'] = '<h2>Conditions d\'utilisation</h2>

<p>By using [Mahara] you are agreeing to the Terms and Conditions given below.</p>

<h3>Nos obligations</h3>
...
$string['uploadcopyrightdefaultcontent'] = 'Oui, le fichier que je désire déposer est ma propriété ou j\'ai la permission exprès de le reproduire et/ou de le distribuer. Mon utilisation de ce fichier n\'enfreint aucune des législations locales de copyright. Ce fichier est en outre conforme aux Conditions d\'utilisation indiquées dans ce site.';
