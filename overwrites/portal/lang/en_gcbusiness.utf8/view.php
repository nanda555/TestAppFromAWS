...
$string['artefactsinthisview'] = 'Artifacts in this page';
...
$string['empty_block'] = 'Select an artifact from the tree on the left to place here';
...
$string['noartefactstochoosefrom'] = 'Sorry, no artifacts to choose from';
...
$string['choosetemplategrouppagedescription'] = '<p>Here you can search through the pages that this group is allowed to copy as a starting point for making a new page. You can see a preview of each page by clicking on its name. Once you have found the page you wish to copy, click the corresponding "Copy Page" button to make a copy and begin customising it.</p><p><strong>Note:</strong> Groups cannot currently make copies of Blogs or Blog Entriess.</p>';
$string['choosetemplateinstitutionpagedescription'] = '<p>Here you can search through the pages that this institution is allowed to copy as a starting point for making a new page. You can see a preview of each page by clicking on its name. Once you have found the page you wish to copy, click the corresponding "Copy Page" button to make a copy and begin customising it.</p><p><strong>Note:</strong> Institutions cannot currently make copies of Blogs or Blog Entries.</p>';
$string['copiedblocksandartefactsfromtemplate'] = 'Copied %d blocks and %d artifacts from %s';
...
$string['sharedviewsdescription'] = 'This page lists the most recently modified or commented on pages that have been shared with you.  They may have been shared with you directly, shared with colleagues of the owner, or shared with one of your groups.';

// Blocks
$string['blocktypecategory.fileimagevideo'] = 'Files and images';