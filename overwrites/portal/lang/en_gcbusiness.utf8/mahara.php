...
$string['pluginexplainartefactblocktypes'] = 'When hiding an \'artifact\' type plugin, the Mahara system also stops the display of the blocks related to it.';
...
$string['pendingfriend'] = 'pending colleague';
...
$string['myfriends']          = 'My Colleagues';
$string['findfriends']        = 'Find Colleagues';
...
$string['artefactnotrendered'] = 'Artifact not rendered';
$string['nodeletepermission'] = 'You do not have permission to delete this artifact';
$string['noeditpermission'] = 'You do not have permission to edit this artifact';
$string['Permissions'] = 'Permissions';
$string['republish'] = 'Publish';
$string['view'] = 'Page';
$string['artefactnotpublishable'] = 'Artifact %s is not publishable in page %s';
...
$string['organisedescription'] = 'Organize your portfolio into <a href="%s">pages.</a>  Create different pages for different audiences - you choose the elements to include.';
$string['sharenetwork'] = 'Share and Network';
$string['sharenetworksubtitle'] = 'Find colleagues and join groups';
$string['findfriendslinked'] = 'Find <a href="%s">Colleagues</a>';
