...
$string['parentlanguage'] = 'en_US.utf8';
...
$string['strfdaymonthyearshort'] = '%%m/%%d/%%Y';
$string['strftimew3cdatetime'] = '%%Y-%%m-%%dT%%T%%z';
$string['strftimew3cdate'] = '%%Y-%%m-%%d';
$string['thislanguage'] = 'Global Classroom Business';
$string['locales'] = 'en_US.utf8,en,english-us,english';
