...
$string['statsmaxfriends'] = 'Has %s colleagues (most is <a href="%s">%s</a> with %d)';
$string['statsnofriends'] = 'Has 0 colleagues :(';
...
$string['allowmobileuploadsdescription'] = 'If enabled users will have the option of setting an authentication token - content uploaded with this token will be saved as artifacts.';
