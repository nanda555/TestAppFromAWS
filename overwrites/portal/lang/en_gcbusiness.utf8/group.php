...
$string['friendformaddsuccess'] = 'Added %s to your colleagues list';
$string['friendformremovesuccess'] = 'Removed %s from your colleagues list';
$string['friendformrequestsuccess'] = 'Sent a colleague request to %s';
$string['friendformacceptsuccess'] = 'Accepted colleague request';
$string['friendformrejectsuccess'] = 'Rejected colleague request';

$string['addtofriendslist'] = 'Add to colleagues';
$string['requestfriendship'] = 'Request colleague';

$string['addedtofriendslistsubject'] = '%s has added you as a colleague';
$string['addedtofriendslistmessage'] = '%s added you as a colleague! This means that %s is also on your colleague list now too. '
    . ' Click on the link below to see their profile page';

$string['requestedfriendlistsubject'] = 'New colleague request';
$string['requestedfriendlistmessage'] = '%s has requested that you add them as a colleague.  '
    .' You can either do this from the link below, or from your colleagues list page';

$string['requestedfriendlistmessagereason'] = '%s has requested that you add them as a colleague.'
    . ' You can either do this from the link below, or from your colleagues list page.'
    . ' Their reason was:
    ';

$string['removefromfriendslist'] = 'Remove from colleagues';
$string['removefromfriends'] = 'Remove %s from colleagues';
$string['confirmremovefriend'] = 'Are you sure you want to remove this user from your colleagues list?';
$string['removedfromfriendslistsubject'] = 'Removed from colleagues list';
$string['removedfromfriendslistmessage'] = '%s has removed you from their colleagues list.';
$string['removedfromfriendslistmessagereason'] = '%s has removed you from their colleagues list.  Their reason was: ';
$string['cantremovefriend'] = 'You cannot remove this user from your colleagues list';

$string['friendshipalreadyrequested'] = 'You have requested to be added to %s\'s colleagues list';
$string['friendshipalreadyrequestedowner'] = '%s has requested to be added to your colleagues list';
$string['rejectfriendshipreason'] = 'Reason for rejecting request';
$string['alreadyfriends'] = 'You are already colleagues with %s';

$string['friendrequestacceptedsubject'] = 'Colleague request accepted';
$string['friendrequestacceptedmessage'] = '%s has accepted your colleague request and they have been added to your colleagues list';
$string['friendrequestrejectedsubject'] = 'Colleague request rejected';
$string['friendrequestrejectedmessage'] = '%s has rejected your colleague request.';
$string['friendrequestrejectedmessagereason'] = '%s has rejected your colleague request.  Their reason was: ';

$string['allfriends']     = 'All Colleagues';
$string['currentfriends'] = 'Current Colleagues';
$string['pendingfriends'] = 'Pending colleagues';
$string['backtofriendslist'] = 'Back to Colleagues List';
$string['findnewfriends'] = 'Find New Colleagues';
$string['Views']          = 'Pages';
$string['Files']          = 'Files';
$string['seeallviews']    = 'See all %s pages...';
$string['noviewstosee']   = 'None that you can see :(';
$string['whymakemeyourfriend'] = 'This is why you should make me your colleague:';
$string['approverequest'] = 'Approve Request!';
$string['denyrequest']    = 'Deny Request';
$string['pending']        = 'pending';
$string['trysearchingforfriends'] = 'Try %ssearching for new colleagues%s to grow your network!';
$string['nobodyawaitsfriendapproval'] = 'Nobody is awaiting your approval to become your colleague';
$string['sendfriendrequest'] = 'Send Colleague Request!';
$string['addtomyfriends'] = 'Add to My Colleagues!';
$string['friendshiprequested'] = 'Colleague requested!';
$string['existingfriend'] = 'existing colleague';
$string['nosearchresultsfound'] = 'No search results found :(';
$string['friend'] = 'colleague';
$string['friends'] = 'colleagues';
$string['user'] = 'user';
$string['users'] = 'users';
$string['Friends'] = 'Colleagues';

$string['friendlistfailure'] = 'Failed to modify your colleagues list';
$string['userdoesntwantfriends'] = 'This user doesn\'t want any new colleagues';
$string['cannotrequestfriendshipwithself'] = 'You cannot request a colleagueship with yourself';
$string['cantrequestfriendship'] = 'You cannot request colleagueship with this user';
...
$string['denyfriendrequest'] = 'Deny Colleague Request';
$string['sendfriendshiprequest'] = 'Send %s a colleagueship request';
$string['cantdenyrequest'] = 'That is not a valid colleagueship request';
$string['cantmessageuser'] = 'You cannot send this user a message';
$string['cantviewmessage'] = 'You cannot view this message';
$string['requestedfriendship'] = 'requested colleagueship';
...
$string['removefriend'] = 'Remove colleague';
$string['denyfriendrequestlower'] = 'Deny colleague request';
