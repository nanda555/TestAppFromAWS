...
$string['friendformaddsuccess'] = 'Added %s to your members list';
$string['friendformremovesuccess'] = 'Removed %s from your members list';
$string['friendformrequestsuccess'] = 'Sent a member request to %s';
$string['friendformacceptsuccess'] = 'Accepted member request';
$string['friendformrejectsuccess'] = 'Rejected member request';

$string['addtofriendslist'] = 'Add to members';
$string['requestfriendship'] = 'Request member';

$string['addedtofriendslistsubject'] = '%s has added you as a member';
$string['addedtofriendslistmessage'] = '%s added you as a member! This means that %s is also on your member list now too. '
    . ' Click on the link below to see their profile page';

$string['requestedfriendlistsubject'] = 'New member request';
$string['requestedfriendlistmessage'] = '%s has requested that you add them as a member.  '
    .' You can either do this from the link below, or from your members list page';

$string['requestedfriendlistmessagereason'] = '%s has requested that you add them as a member.'
    . ' You can either do this from the link below, or from your members list page.'
    . ' Their reason was:
    ';

$string['removefromfriendslist'] = 'Remove from members';
$string['removefromfriends'] = 'Remove %s from members';
$string['confirmremovefriend'] = 'Are you sure you want to remove this user from your members list?';
$string['removedfromfriendslistsubject'] = 'Removed from members list';
$string['removedfromfriendslistmessage'] = '%s has removed you from their members list.';
$string['removedfromfriendslistmessagereason'] = '%s has removed you from their members list.  Their reason was: ';
$string['cantremovefriend'] = 'You cannot remove this user from your members list';

$string['friendshipalreadyrequested'] = 'You have requested to be added to %s\'s members list';
$string['friendshipalreadyrequestedowner'] = '%s has requested to be added to your members list';
$string['rejectfriendshipreason'] = 'Reason for rejecting request';
$string['alreadyfriends'] = 'You are already members with %s';

$string['friendrequestacceptedsubject'] = 'Member request accepted';
$string['friendrequestacceptedmessage'] = '%s has accepted your member request and they have been added to your members list';
$string['friendrequestrejectedsubject'] = 'Member request rejected';
$string['friendrequestrejectedmessage'] = '%s has rejected your member request.';
$string['friendrequestrejectedmessagereason'] = '%s has rejected your member request.  Their reason was: ';

$string['allfriends']     = 'All Members';
$string['currentfriends'] = 'Current Members';
$string['pendingfriends'] = 'Pending members';
$string['backtofriendslist'] = 'Back to Members List';
$string['findnewfriends'] = 'Find New Members';
$string['Views']          = 'Pages';
$string['Files']          = 'Files';
$string['seeallviews']    = 'See all %s pages...';
$string['noviewstosee']   = 'None that you can see :(';
$string['whymakemeyourfriend'] = 'This is why you should make me your member:';
$string['approverequest'] = 'Approve Request!';
$string['denyrequest']    = 'Deny Request';
$string['pending']        = 'pending';
$string['trysearchingforfriends'] = 'Try %ssearching for new members%s to grow your network!';
$string['nobodyawaitsfriendapproval'] = 'Nobody is awaiting your approval to become your member';
$string['sendfriendrequest'] = 'Send Member Request!';
$string['addtomyfriends'] = 'Add to My Members!';
$string['friendshiprequested'] = 'Member requested!';
$string['existingfriend'] = 'existing member';
$string['nosearchresultsfound'] = 'No search results found :(';
$string['friend'] = 'member';
$string['friends'] = 'members';
$string['user'] = 'user';
$string['users'] = 'users';
$string['Friends'] = 'Members';

$string['friendlistfailure'] = 'Failed to modify your members list';
$string['userdoesntwantfriends'] = 'This user doesn\'t want any new members';
$string['cannotrequestfriendshipwithself'] = 'You cannot request a membership with yourself';
$string['cantrequestfriendship'] = 'You cannot request membership with this user';
...
$string['denyfriendrequest'] = 'Deny Member Request';
$string['sendfriendshiprequest'] = 'Send %s a membership request';
$string['cantdenyrequest'] = 'That is not a valid membership request';
$string['cantmessageuser'] = 'You cannot send this user a message';
$string['cantviewmessage'] = 'You cannot view this message';
$string['requestedfriendship'] = 'requested membership';
...
$string['removefriend'] = 'Remove member';
$string['denyfriendrequestlower'] = 'Deny member request';
