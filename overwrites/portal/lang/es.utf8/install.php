...
$string['aboutdefaultcontent'] = '<h2>Acerca de Mahara</h2>

<p>Fundada en 2006, Mahara es el resultado de un proyecto de colaboración financiado por Nueva Zelanda \ s de la educación terciaria Comisión \' s de e-learning de Colaboración para el Desarrollo (FDEA), involucrando a la Universidad de Massey, Auckland University of Technology, la Politécnica Abierta de Nueva Zelanda y la Universidad Victoria de Wellington.</p>

<p>Mahara es una cartera con todas las funciones electrónicas, weblog, reanudar el constructor y el sistema de redes sociales, conectar a los usuarios y la creación de comunidades en línea. Mahara está diseñado para proporcionar a los usuarios las herramientas necesarias para crear un aprendizaje personal y profesional y entorno de desarrollo.</p>

<p>Meaning `think\' or `thought\' in Te Reo Maori,  el nombre refleja el colaborador del proyecto \ s dedicación a la creación de una vida centrada en el usuario el aprendizaje permanente y desarrollo de aplicaciones, así como la creencia de que las soluciones de tecnología no puede ser desarrolladas fuera de las consideraciones de la pedagogía y la política.</p>

<p>Mahara se ofrece libremente como software de código abierto (bajo la licencia GNU General Public License). En resumen, esto significa que se le permite copiar, usar y modificar Mahara siempre y cuando se compromete a:</p>

<ul>
    <li>proporcionar el código fuente a los demás; </li>
    <li>no modificar o eliminar la licencia original y los derechos de autor, y</li>
    <li>aplicar esta misma licencia a cualquier trabajo derivado.</li>
</ul>

<p>Por favor, no dude en <a href="contact.php">Contacte con nosotros</a> Si usted tiene alguna pregunta relacionada con Mahara.</p>

<p><a href="http://mahara.org">http://mahara.org</a></p>';
$string['homedefaultcontent'] = '<h2>Bienvenido a</h2>

<p>Mahara es una cartera con todas las funciones electrónicas, weblog, reanudar el constructor y el sistema de redes sociales, conectar a los usuarios y la creación de comunidades en línea. Mahara le proporciona las herramientas necesarias para configurar un aprendizaje personal y el entorno de desarrollo.</p>

<p>Para obtener más información se puede leer <a href="about.php">Acerca de</a> Mahara  o, alternativamente, por favor, no dude en <a href="contact.php">Contacte con nosotros</a>.</p>';
...
$string['uploadcopyrightdefaultcontent'] = 'Acepto los Terminos y Condiciones de Uso';
