...
{
    $CFG->current_app->gcError('Unprivileged attempted access to /eschooladmin/settings.php', 
            'gcpageaccessdenied');
}
...
$siteoptionform = array(
    ...
    'elements'   => array(
        ...
        'securitysettings' => array(
            ...
            'elements'     => array(
                'gc_restrict_access_by_institution' => array(
                    'type'         => 'checkbox',
                    'title'        => get_string('gc_restrict_access_by_institution', 'artefact.eschooladmin'),
                    'description'  => get_string('gc_restrict_access_by_institution_description', 'artefact.eschooladmin'),
                    'defaultvalue' => get_config('gc_restrict_access_by_institution'),
                ),
                /*
                'viruschecking' => array(
                    'type'         => 'checkbox',
        ...
        'generalsettings' => array(
            ...
            'elements'     => array(
                ...
                'gcralternateloginurl' => array(
                    'type'         => 'text',
                    'title'        => 'Set an Alternate Login URL for this platform',
                    'description'  => 'If set, users will be redirected to the saved URL instead of the normal login page',
                    'defaultvalue' => get_config('gcralternateloginurl'),
                    'disabled'     => in_array('gcralternateloginurl', $OVERRIDDEN),
                ),/*
                ...
                'disableeditdashboardbutton' => array(
                    'type'         => 'checkbox',
                    'title'        => get_string('disableeditdashboardbutton', 'artefact.eschooladmin'),
                    'description'  => get_string('disableeditdashboardbuttondescription', 'artefact.eschooladmin'),
                    'defaultvalue' => get_config('disableeditdashboardbutton'),
                    'disabled'     => in_array('disableeditdashboardbutton', $OVERRIDDEN),
                ),/*
...
function siteoptions_fail(Pieform $form, $field) {
    $form->reply(PIEFORM_ERR, array(
        ...
        'goto'    => '/artefact/eschooladmin/settings.php',
    ));
}
...
function siteoptions_submit(Pieform $form, $values) {
    $fields = array(
        ...
        'lang', 'country', 'creategroups', 'createpublicgroups', 'allowgroupcategories', 'allowpublicviews', 'allowpublicprofiles',
        'showselfsearchsideblock', 'showonlineuserssideblock', 'registerterms', 'gc_limit_user_visibility', 
        'gc_restrict_access_by_institution', 'gcralternateloginurl', 'disableeditdashboardbutton'
    );
    ...
    $message = get_string('siteoptionsset', 'admin');
    $form->reply(PIEFORM_OK, array('message' => $message, 'goto' => '/artefact/eschooladmin/settings.php'));
}
...
$smarty->display('artefact:eschooladmin:settings.tpl');
