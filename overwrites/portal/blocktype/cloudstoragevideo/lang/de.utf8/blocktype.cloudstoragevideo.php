...
$string['title'] = 'Cloud Storage Video';
$string['description'] = 'Embed externe Videos von Cloud-Storage';
$string['videourl'] = 'Cloud Storage Video URL';
$string['videourldescription'] = 'Kopieren Sie die URL der Seite in dieses Feld';
$string['videourldescription2'] = 'Wählen Sie eine Videodatei aus Cloud-Storage einzubetten:';
$string['width'] = 'Breite';
$string['height'] = 'Höhe';
