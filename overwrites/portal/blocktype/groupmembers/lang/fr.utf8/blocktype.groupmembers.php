...
$string['options_order_title'] = 'Sélection';
$string['options_order_desc'] = 'Vous pouvez afficher les derniers membres du groupe ou un ensemble de membres tirés au hasard.';

$string['Latest'] = 'Derniers';
