...
$string['notusable'] = 'Veuillez installer les extensions PHP XMLRPC, cURL et OpenSSL sur votre serveur';
$string['networkingdisabledonthissite'] = 'Le réseau est désactivé sur ce site';
$string['networkservers'] = 'Serveurs du réseau';
$string['youhaveloggedinfrom'] = 'Vous avez été connecté par <a href="%s">%s</a>.';
